...
class in_results_card_entry(models.Model):
    ...
    total_obtained_marks = models.FloatField(null=True, blank=True, default=0)
...
#     reg_id = models.ForeignKey(in_registrations, null=True, blank=True, related_name='reg_id2res_carddtls', on_delete=models.DO_NOTHING)
#     def_mode_id = models.ForeignKey(defaults_exam_modes, null=True, blank=True, related_name='def_mode_id2res_carddtls', on_delete=models.DO_NOTHING)
#     is_mode_name = models.CharField(max_length=30, null=True, blank=True)
#     is_modes_marks = models.IntegerField(null=True, blank=True, default=0)
#     is_english = models.BooleanField(default=False)
#     is_bangla = models.BooleanField(default=False)
#     is_approved = models.BooleanField(default=False)
#     is_approved_by = models.ForeignKey(User, null=True, blank=True, related_name='user_id2res_carddtls', on_delete=models.DO_NOTHING)
#     approved_date = models.CharField(max_length=50, null=True, blank=True)
...
# class in_results_card_grade_info(models.Model):
#     res_grade_info_id = models.BigAutoField(primary_key=True, default=1303403300001, editable=False)
#     res_card_id = models.ForeignKey(in_results_card_entry, null=True, blank=True, related_name='res_card_id2grade_info', on_delete=models.DO_NOTHING)
#     subjects_id = models.ForeignKey(in_subjects, null=True, blank=True, related_name='subjects_id2grade_info', on_delete=models.DO_NOTHING)
#     reg_id = models.ForeignKey(in_registrations, null=True, blank=True, related_name='reg_id2grade_info', on_delete=models.DO_NOTHING)
#     is_modes_total = models.IntegerField(null=True, blank=True, default=0)
#     is_letter_grade = models.CharField(max_length=30, null=True, blank=True)
#     is_gp = models.CharField(max_length=10, null=True, blank=True)
#     is_english = models.BooleanField(default=False)
#     is_bangla = models.BooleanField(default=False)
#     is_approved = models.BooleanField(default=False)
#     is_approved_by = models.ForeignKey(User, null=True, blank=True, related_name='user_id2grade_info', on_delete=models.DO_NOTHING)
#     approved_date = models.CharField(max_length=50, null=True, blank=True)
#     ss_creator = models.ForeignKey(User, null=True, blank=True, related_name='ss_creator2grade_info', on_delete=models.DO_NOTHING, editable=False)
#     ss_created_on = models.DateTimeField(auto_now_add=True)
#     ss_created_session = models.BigIntegerField(null=True, blank=True, default=1355070000000, editable=False)
#     ss_modifier = models.ForeignKey(User, null=True, blank=True, related_name='ss_modifier2grade_info', on_delete=models.DO_NOTHING)
#     ss_modified_on = models.DateTimeField(auto_now=True)
#     ss_modified_session = models.BigIntegerField(null=True, blank=True, default=1994376000000, editable=False)

#     def save(self, *args, **kwargs):
#         last_data = in_results_card_grade_info.objects.all()

#         if last_data.exists() and self._state.adding:
#             last_order = last_data.latest('res_grade_info_id')
#             user_session = last_data.latest('ss_created_session')
#             modifier_session = last_data.latest('ss_modified_session')
#             self.res_grade_info_id = int(last_order.res_grade_info_id) + 1
#             self.ss_created_session = int(user_session.ss_created_session) + 1
#             self.ss_modified_session = int(modifier_session.ss_modified_session) + 1
#         super().save(*args, **kwargs)

#     def __str__(self):
#         return str(self.res_grade_info_id)
