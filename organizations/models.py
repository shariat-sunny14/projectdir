...
class organizationlst(models.Model):
    ...
    is_start_up = models.DateField(null=True, blank=True)
    service_charge = models.IntegerField(null=True, blank=True)
    is_alert_start = models.IntegerField(null=True, blank=True)
    is_alert_end = models.IntegerField(null=True, blank=True)
    ...
    ser_char_alert = models.BooleanField(default=False)
    is_delivery_chalan = models.BooleanField(default=False)
    is_grn = models.BooleanField(default=False)
    is_lp = models.BooleanField(default=False)
    is_mrr = models.BooleanField(default=False)
    is_store_trans = models.BooleanField(default=False)
    is_stock_recon = models.BooleanField(default=False)
