...
urlpatterns = [
    ...
    # Annual Tabulation Report URLs
    path('annual_tabulation_reports/', views.annualTabulationReportsManagerAPI, name='annual_tabulation_reports'),
    path('annual_tabulation_details_reports/', views.annualTabulationdetailsReportsAPI, name='annual_tabulation_details_reports'),
]