...
class local_purchase(models.Model):
    lp_id = models.BigAutoField(primary_key=True, default=2202022100000, editable=False, db_index=True)
    lp_no = models.CharField(max_length=15, editable=False, db_index=True)
    transaction_date = models.DateField(null=True, blank=True, db_index=True)
    id_org = models.ForeignKey(organizationlst, null=True, blank=True, related_name='org_id2lp_rec', on_delete=models.DO_NOTHING, db_index=True)
    branch_id = models.ForeignKey(branchslist, null=True, blank=True, related_name='branch_id2lp_rec', on_delete=models.DO_NOTHING, db_index=True)
    store_id = models.ForeignKey(store, null=True, blank=True, related_name='store_id2lp_rec', on_delete=models.DO_NOTHING, editable=False, db_index=True)
    reg_id = models.ForeignKey(in_registrations, null=True, blank=True, related_name='reg_id2lp_rec', on_delete=models.DO_NOTHING, db_index=True)
    ...
    is_approved_by = models.ForeignKey(User, null=True, blank=True, related_name='user_id2lp_rec', on_delete=models.DO_NOTHING, db_index=True)
    is_returned_by = models.ForeignKey(User, null=True, blank=True, related_name='user_id2is_lpret_by', on_delete=models.DO_NOTHING, db_index=True)
    ...
    class Meta:
        indexes = [
            models.Index(fields=['id_org', 'branch_id', 'reg_id', 'transaction_date', 'is_approved']),
            models.Index(fields=['lp_no']),  # for lookup by invoice no
        ]
...
class local_purchasedtl(models.Model):
    lp_dtl_id = models.BigAutoField(primary_key=True, default=1005555000000, editable=False, db_index=True)
    lp_id = models.ForeignKey(local_purchase, null=True, blank=True, on_delete=models.DO_NOTHING, editable=False, db_index=True)
    lp_rec_date = models.DateField(blank=True, null=True, db_index=True)
    store_id = models.ForeignKey(store, null=True, blank=True, related_name='store_id2lp_recDtl', on_delete=models.DO_NOTHING, editable=False, db_index=True)
    reg_id = models.ForeignKey(in_registrations, null=True, blank=True, related_name='reg_id2lp_recDtl', on_delete=models.DO_NOTHING, db_index=True)
    item_id = models.ForeignKey(items, null=True, blank=True, related_name='item_id2lp_recDtl', on_delete=models.DO_NOTHING, editable=False, db_index=True)
    is_approved = models.BooleanField(default=False, db_index=True)
    approved_date = models.CharField(max_length=50, null=True, blank=True)
    ...
    class Meta:
        indexes = [
            models.Index(fields=['lp_id', 'reg_id', 'lp_rec_date', 'is_approved']),
