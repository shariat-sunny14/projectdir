...
def saveInquireManagerAPI(request):
    ...
    if request.method == "POST":
        ...
        try:
            ...
            # ==========================================
            # ✅ Inquiry DB তে commit হয়ে গেছে, এখন org_info.email এ
            ...
            try:
                ...
                if org and org.email:
                    ...
                    subject = f"New Inquiry Received - Inquiry #{inquiry.inquire_id}"
                    body = f"""
A new inquiry has been submitted.

Inquiry ID: {inquiry.inquire_id}
Full Name: {inquiry.full_name}
Customer Email: {inquiry.email}
Phone: {inquiry.phone_number}
Inquire Type: {inquiry.inquire_type}
Your Questions: {inquiry.your_questions}
Your Planned: {inquiry.your_planned}
Discover Type: {inquiry.discover_type}
