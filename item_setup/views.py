...
def item_setupAPI(request):
    ...
    store_list = store.objects.filter(is_active=True, org_id__in=org_list)
...
def item_addAPI(request):
    ...
    try:
        with transaction.atomic():
            ...
            org_id = data.get('org')
            store_id = data.get('default_store')
            ...
            if category_id:
                category_instance = item_category.objects.get(category_id=category_id)
            else:
            ...
            item_data.default_store = store_instance
            ...
            item_data.category_id = category_instance
...
def getItemListAPI(request, item_id):
    ...
    try:
        ...
        item_dtls.append({
            ...
            'default_store': item_list.default_store.store_id if item_list.default_store else None,
