...
def examTypeSaveandUpdateManagerAPI(request):
    ...
    try:
        with transaction.atomic():
            ...
            type_data.is_half_yearly = data.get('is_half_yearly', 0)
            type_data.is_yearly = data.get('is_yearly', 0)
...
def selectExamTypeDataManagerAPI(request, exam_type_id):
    ...
    try:
        ...
        type_Dtls.append({
            ...
            'is_half_yearly': type_list.is_half_yearly,
            'is_yearly': type_list.is_yearly,
