...
class carrying_cost_payments(models.Model):
    c_cost_id = models.BigAutoField(primary_key=True, default=4411220000000, editable=False)
    c_cost_date = models.DateField(default=datetime.now, editable=False)
    pay_inv_date = models.DateField(null=True, blank=True)
    org_id = models.ForeignKey(organizationlst, null=True, blank=True, related_name='org_id2c_cost_pay', on_delete=models.DO_NOTHING)
    branch_id = models.ForeignKey(branchslist, null=True, blank=True, related_name='branch_id2c_cost_pay', on_delete=models.DO_NOTHING)
    driver_id = models.ForeignKey(drivers_list, null=True, blank=True, related_name='driver_id2c_cost_pay', on_delete=models.DO_NOTHING)
...
class without_invoice_collection(models.Model):
    wo_coll_id = models.BigAutoField(primary_key=True, default=2000220020000, editable=False)
    coll_date = models.DateField(default=datetime.now, editable=False)
    collection_mode = models.CharField(max_length=10, null=True, blank=True)
    collection_type = models.CharField(max_length=10, null=True, blank=True)
    collection_amt = models.FloatField(default=0, blank=True)
    org_id = models.ForeignKey(organizationlst, null=True, blank=True, related_name='org_id2wo_inv_coll', on_delete=models.DO_NOTHING)
    branch_id = models.ForeignKey(branchslist, null=True, blank=True, related_name='branch_id2wo_inv_coll', on_delete=models.DO_NOTHING)
    reg_id = models.ForeignKey(in_registrations, null=True, blank=True, related_name='reg_id2wo_inv_coll', on_delete=models.DO_NOTHING, editable=False)
    customer_name = models.CharField(max_length=100, null=True, blank=True)
    gender = models.CharField(max_length=20, null=True, blank=True)
