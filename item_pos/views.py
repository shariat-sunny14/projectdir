...
def save_pos(request):
    ...
    try:
        with transaction.atomic():
            ...
            other_exps_amt = int(other_exps_amt) if other_exps_amt else 0
            pay_amt = int(pay_amt) if pay_amt else 0
            ...
            if pay_amt > 0 and collection_mode == 1:
                ...
                # Update the on_hand_cash with the correct total
                totalPayment = pay_amt - other_exps_amt

                # Update the on_hand_cash by adding totalPayment
