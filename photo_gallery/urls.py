...
urlpatterns = [
    ...
    path('api/recent-work-photo-types/', views.recent_work_photo_types_ajax, name='recent_work_photo_types_ajax'),
    ...
    path('api/services-photo-types/', views.services_photo_types_ajax, name='services_photo_types_ajax'),
