...
class lp_return_details(models.Model):
    lprdtl_id = models.BigAutoField(primary_key=True, default=6677100000000, editable=False, db_index=True)
    lp_id = models.ForeignKey(local_purchase, null=True, blank=True, related_name='lp_id2lprdtl', on_delete=models.DO_NOTHING, editable=False, db_index=True)
    store_id = models.ForeignKey(store, null=True, blank=True, related_name='store_id2lprdtl', on_delete=models.DO_NOTHING, editable=False, db_index=True)
    item_id = models.ForeignKey(items, null=True, blank=True, related_name='item_id2lprdtl', on_delete=models.DO_NOTHING, editable=False, db_index=True)
    ...
    returned_date = models.CharField(max_length=150, null=True, blank=True, db_index=True)
    is_returned_by = models.ForeignKey(User, null=True, blank=True, related_name='user_id2lprdtl', on_delete=models.DO_NOTHING, db_index=True)
    ...
    class Meta:
        indexes = [
            models.Index(fields=['lp_id', 'item_id', 'is_returned']),
