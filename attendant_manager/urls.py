...
urlpatterns = [
    ...
    path('approved_rollback_attendant/', views.approvedRollbackAttendantManagerAPI, name='approved_rollback_attendant'),
    path('approved_rollback_attendant_submission/', views.approvedRollbackAttendantSubmissionAPI, name='approved_rollback_attendant_submission'),
]