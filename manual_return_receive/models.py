...
class manual_return_receive(models.Model):
    manu_ret_rec_id = models.BigAutoField(primary_key=True, default=9909099100000, editable=False, db_index=True)
    ...
    id_org = models.ForeignKey(organizationlst, null=True, blank=True, related_name='org_id2manu_ter_rec', on_delete=models.DO_NOTHING, db_index=True)
    branch_id = models.ForeignKey(branchslist, null=True, blank=True, related_name='branch_id2manu_ter_rec', on_delete=models.DO_NOTHING, db_index=True)
    store_id = models.ForeignKey(store, null=True, blank=True, related_name='store_id2manu_ter_rec', on_delete=models.DO_NOTHING, editable=False, db_index=True)
    reg_id = models.ForeignKey(in_registrations, null=True, blank=True, related_name='reg_id2manu_ter_rec', on_delete=models.DO_NOTHING, db_index=True)
    is_cash = models.BooleanField(default=False)
    is_credit = models.BooleanField(default=False)
    is_approved = models.BooleanField(default=False, db_index=True)
    is_approved_by = models.ForeignKey(User, null=True, blank=True, related_name='user_id2manu_ter_rec', on_delete=models.DO_NOTHING, db_index=True)
    ...
    class Meta:
        indexes = [
            ...
            models.Index(fields=['manu_ret_rec_no']),  # already unique-ish
        ]
...
class manual_return_receivedtl(models.Model):
    manu_ret_rec_dtl_id = models.BigAutoField(primary_key=True, default=8008588000000, editable=False, db_index=True)
    manu_ret_rec_id = models.ForeignKey(manual_return_receive, null=True, blank=True, on_delete=models.DO_NOTHING, editable=False, db_index=True)
    manu_ret_rec_date = models.DateField(blank=True, null=True, db_index=True)
    store_id = models.ForeignKey(store, null=True, blank=True, related_name='store_id2manu_ter_recDtl', on_delete=models.DO_NOTHING, editable=False, db_index=True)
    reg_id = models.ForeignKey(in_registrations, null=True, blank=True, related_name='reg_id2manu_ter_recDtl', on_delete=models.DO_NOTHING, db_index=True)
    item_id = models.ForeignKey(items, null=True, blank=True, related_name='item_id2manu_ter_recDtl', on_delete=models.DO_NOTHING, editable=False, db_index=True)
    is_approved = models.BooleanField(default=False, db_index=True)
    approved_date = models.CharField(max_length=50, null=True, blank=True)
    ...
    class Meta:
        indexes = [
            models.Index(fields=['manu_ret_rec_id', 'reg_id', 'manu_ret_rec_date', 'is_approved']),
