...
class paymentsdtls(models.Model):
    ...
    supplier_id = models.ForeignKey(suppliers, null=True, blank=True, related_name='supplier_id2paydtls', on_delete=models.DO_NOTHING)
    pay_date = models.DateField(auto_now_add=True)
    is_reg_client = models.BooleanField(default=False)
    is_supplier_party = models.BooleanField(default=False)
