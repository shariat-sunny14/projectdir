...
class EnrollList(models.Model):
    ...
    # display order for the public website's training/packages section —
    # lower shows first. Not null (default 0) so ordering never has to
    # deal with NULLs sorting inconsistently across DBs.
    order_by = models.IntegerField(default=0, blank=True)
