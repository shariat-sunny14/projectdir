...
urlpatterns = [
    ...
    # 
    path('grn_app_details_report_services/', views.grnAppDetailsReportsAPI, name='grn_app_details_report_services'),
    path('grn_app_summary_report_services/', views.grnAppSummaryReportsAPI, name='grn_app_summary_report_services'),
    path('get_grn_app_details_reports_data/', views.getGRNAppDetailsReportsDataAPI, name="get_grn_app_details_reports_data"),
    path('get_grn_app_summary_reports_data/', views.getGRNAppSummaryReportsDataAPI, name="get_grn_app_summary_reports_data"),
]