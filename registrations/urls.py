...
urlpatterns = [
    ...
    path('get_registration_client_due_status/', views.getRegistrationClientDueStatusViewAPI, name="get_registration_client_due_status"),
    path('get_reg_client_due_balance_from_json/', views.getClientBalanceFromJson, name="get_reg_client_due_balance_from_json"),
    path('get_summary_due_balance_of_reg_clients/', views.getsummaryDueBalanceOfRegClientsAPI, name="get_summary_due_balance_of_reg_clients"),
]
