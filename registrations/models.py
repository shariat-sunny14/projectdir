...
class in_registrations(models.Model):
    ...
    is_optional_sub = models.ForeignKey(in_subjects, null=True, blank=True, related_name='subjects_id2in_reg', on_delete=models.DO_NOTHING)
    ...
    ##################################### Restriction Reasons flag #####################################
    # Academic
    is_transferred = models.BooleanField(default=False)
    is_promoted_passed_out = models.BooleanField(default=False)
    is_fail_removed = models.BooleanField(default=False)
    is_lack_of_attendance = models.BooleanField(default=False)
    # Disciplinary
    is_rusticated = models.BooleanField(default=False)
    is_expelled = models.BooleanField(default=False)
    is_misbehavior = models.BooleanField(default=False)
    is_policy_violation = models.BooleanField(default=False)
    # Personal
    is_family_shift = models.BooleanField(default=False)
    is_financial_problem = models.BooleanField(default=False)
    is_personal_health_problem = models.BooleanField(default=False)
    is_family_decision = models.BooleanField(default=False)
    # Legal / Official
    is_court_ordered = models.BooleanField(default=False)
    is_government_directive = models.BooleanField(default=False)
    # Misc
    is_death = models.BooleanField(default=False)
    is_missing = models.BooleanField(default=False)
    is_admission_cancelled = models.BooleanField(default=False)
    is_unauthorized_absent = models.BooleanField(default=False)
    ##################################### Restriction Reasons flag end #####################################
